...
firstLongName.ifPresent(System.out::println); // Алексей`,
    ...
    },
    {
      ...
      type: "content",
      content:
        "Регулярные выражения (RegEx) — это мощный инструмент для поиска, извлечения и манипуляции текста на основе шаблонов. В Java для работы с ними используются классы `Pattern` и `Matcher` из пакета `java.util.regex`.",
    },
    {
      id: "slide-25",
